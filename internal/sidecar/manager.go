...
func launchArgsJSON(cfg Config) ([]byte, error) {
	...
	if cfg.ExecutablePath != "" {
		launchArgs["executable_path"] = cfg.ExecutablePath
	}
	if cfg.Persistent {
...
if managed_executable_path:
    ...
    # Camoufox 0.4.11 otherwise consults its moving global browser cache for
    # properties, version, and addons even when executable_path is supplied.
